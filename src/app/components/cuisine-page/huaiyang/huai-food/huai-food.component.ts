...
export class HuaiFoodComponent implements OnInit {
  ...
  huaiFoodList: FeaturedFood[] = [
    new FeaturedFood('Shangdong Cuisine3', '../../../../../assets/images/cuisines/lu-food.png',
    ...
    new FeaturedFood('Cantonese Cuisine3', '../../../../../assets/images/cuisines/yue-food.png',
