...
export class ChuanFoodComponent implements OnInit {
  ...
  chuanFoodList: FeaturedFood[] = [
    new FeaturedFood('Shangdong Cuisine2', '../../../../../assets/images/cuisines/lu-food.png',
    ...
    new FeaturedFood('Cantonese Cuisine2', '../../../../../assets/images/cuisines/yue-food.png',
    ...
    new FeaturedFood('Sichuan Cuisine2', '../../../../../assets/images/cuisines/sc-food.png',
    ...
    new FeaturedFood('Huiyang Cuisine2', '../../../../../assets/images/cuisines/hy-food.png',
